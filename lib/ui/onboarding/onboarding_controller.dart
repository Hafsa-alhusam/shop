...
class OnboardingController extends GetxController {
  ...
  @override
  void onInit() => {pageController = PageController(), super.onInit()};
  ...
  void goToSignin() => Get.offNamed(AppRoutes.auth);
...
class OnboardingModel {
  ...
  final String button;
  OnboardingModel(
      {required this.description, required this.image, required this.title, required this.button});
